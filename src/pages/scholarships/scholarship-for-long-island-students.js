...
import { longIslandStudents } from '../../utils/embedScripts';
...
export default function ScholarshipLongIslandStudents({ location }) {
  useEffect(() => {
    postscribe('#formEmbed', longIslandStudents);
  }, []);
  ...
  const heroData = {
    heading: 'Scholarship for Long Island Students',
  };

  return (
    <Layout location={location}>
      <Helmet>
        <title>Scholarship for Long Island Students - RingSavvy, Inc.</title>
        <meta
          name='description'
          content='Scholarship for Long Island Students - RingSavvy, Inc.'
        />
      </Helmet>
          ...
          <FlexRow wrap>
            <Content>
              ...
              <p>
                ...
                Long Island, we are excited to be able to give back to our home
                and community by offering a merit scholarship.
              </p>
              ...
              <ul>
                ...
                <li>Applicants must provide proof of Long Island residence.</li>
                ...
                <li>
                  ...
                  including any and all additional essays, transcripts, proof of
                  residence, and information asked for in the application.
                </li>
              </ul>
