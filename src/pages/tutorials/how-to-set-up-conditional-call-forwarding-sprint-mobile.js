...
export default function ConditionalForwardingSprint({ location }) {
  const heroData = {
    heading:
      'How To Set Up Conditional Call Forwarding From a Typical Sprint Cell Phone',
  };
  ...
  return (
    <Layout location={location}>
      <Helmet>
        <title>
          How To Set Up Conditional Call Forwarding From a Typical Sprint Cell
          Phone - RingSavvy, Inc.
        </title>
        <meta
          name='description'
          content='Steps to set up conditional call forwarding on a Sprint cell phone.'
        />
      </Helmet>
      ...
      <SecondaryContent hasSidebar learnMoreData={learnMoreData}>
        ...
        <h2>
          How to set up conditional call forwarding on your Sprint cell phone:
          Follow these simple steps!
        </h2>
        <p>
          Step 1: Open the dialer on your mobile phone and dial *73 (do not
          press call yet.)
        </p>
        <p>
          Step 2: Following the *73, dial the 10 digit telephone number you
        ...
        <p>Step 4: Dial *74 (do not press call yet)</p>
        <p>
          Step 5: Following the *74, dial the 10 digit telephone number you
          would like to forward your calls to.
        </p>
        <p>
          Step 6: Press call and listen for a successful response from the auto
          attendant.
        </p>
        <p>
          ...
          is working properly by calling your Sprint mobile phone from another
        ...
        <p>
          To turn off conditional call forwarding from your Sprint cell phone,
          simply punch in *730 and press call. Then press *740 and press call.
          Listen for a successful message stating call forwarding has been
          deactivated.
        </p>
        <p>
          Even if you have received a message that the call forwarding has been
