...
export default function ScholarshipTradeSchools({ location }) {
  useEffect(() => {
        ...
        <Wrapper>
          <FlexRow wrap>
            <Content>
              ...
              <p>
                Ring Savvy is proud to offer a scholarship to help young men and
                women pay for trade school and enjoy a promising career and
                future. This scholarship is merit based and seeks to help those
                who may not have chosen an academic career path but exemplify
                hard work, diligence, and perseverance through their trade
                school endeavors.
              </p>
              <h2>Scholarship criteria</h2>
              <p>
                The Ring Savvy Foundation Scholarship for Trade Schools is open
              ...
              <p>
                ...
                students must meet the scholarship’s minimum criteria and submit
