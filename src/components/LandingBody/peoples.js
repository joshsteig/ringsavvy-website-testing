    ...
    <Container className='benefitsContainer'>
      <Row className='landing-reverse-col'>
        ...
        <Col xs={12} lg={6} style={{ margin: 'auto' }}>
          <h3>The industry-wide problem</h3>
      ...
      <Row style={{ marginTop: '30px' }}>
        <Col xs={12} lg={6} style={{ margin: 'auto' }}>
          <h3>The Ring Savvy solution:</h3>
          <p className='benefits_details'>
            Ring Savvy enables you to focus on the task at hand, while not
            sacrificing customer service or losing out on new customers.
          </p>
        </Col>
        <Col lg={1} />
