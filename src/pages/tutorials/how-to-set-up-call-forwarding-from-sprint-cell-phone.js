...
export default function CallForwardingSprint({ location }) {
  const heroData = {
    heading: 'How To Set Up Call Forwarding From a Typical Sprint Cell Phone',
  };
  ...
  return (
    <Layout location={location}>
      <Helmet>
        <title>
          How To Set Up Call Forwarding From a Typical Sprint Cell Phone -
          RingSavvy, Inc.
        </title>
        <meta
          name='description'
          content='Steps to set up call forwarding on a typical Sprint cell phone.'
        />
      </Helmet>
